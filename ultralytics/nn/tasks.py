...
from ultralytics.nn.add_modules.MSAM import *
from ultralytics.nn.add_modules.imMSAM import *
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            c2 = ch[f[-1]]    
        elif m in [MultiResSimAM]:
            args = [*args[:]]
            
        elif m in [MSAM,CBAM,DWRAttention,ECA,MSAM_Improve_LargeTarget]:
            c1, c2 = ch[f], args[0]
            if c2 != nc:
                c2 = make_divisible(min(c2, max_channels) * width, 8)
            args = [c1, *args[1:]]
            ...
            t = m
            m = timm.create_model(m, pretrained=args[0], features_only=True, pretrained_cfg_overlay=dict(file='ultralytics/nn/add_modules/repghost_100.bin'))
